...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../final.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x140
SOPC_SYSID_FLAG += --sidp=0x140
ELF_PATCH_FLAG  += --sidp 0x140

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1598878500
SOPC_SYSID_FLAG += --timestamp=1598878500
ELF_PATCH_FLAG  += --timestamp 1598878500
