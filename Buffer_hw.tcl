...
set_module_property NAME Buffer
set_module_property VERSION 1.4
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME Buffer
...
set_interface_property AES_Slave addressUnits SYMBOLS
...
add_interface_port AES_Slave AVL_ADDR address Input 3
add_interface_port AES_Slave AVL_READDATA readdata Output 8
add_interface_port AES_Slave AVL_WRITEDATA writedata Input 8
add_interface_port AES_Slave AVL_CS chipselect Input 1
add_interface_port AES_Slave AVL_BYTE_EN byteenable Input 1
